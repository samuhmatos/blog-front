...
export function NotFoundPage({ hFullscreen }: Props) {
  ...
  return (
    <div
      className={twMerge(
        "w-full flex flex-col lg:flex-row items-center justify-center space-y-4 p-2 lg:space-y-0 space-x-4 2xl:space-x-0",
        hFullscreen && "h-screen"
      )}
    >
      <div className="w-full  lg:w-1/2 flex flex-col items-center justify-center lg:px-2 xl:px-0 text-center">
        ...
        <p className="text-lg md:text-xl lg:text-2xl text-gray-500 my-12">
          Me desculpa, mas a página que está procurando não foi encontrada. Será
          que você escreveu corretamente? 🫣
        </p>
        ...
        <Button
          ...
          className="text-base"
          endIcon={<Icon name="ArrowLeft" size="text-sm" />}
          onClick={handleNavigation}
        />
      </div>
      <div className="w-full 4sm:w-3/4 3sm:w-2/3 md:w-1/2 lg:h-full flex lg:items-end justify-center p-4">
        <svg
